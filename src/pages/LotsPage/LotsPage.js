...
export const LotsPage = () => {
    ...
    return (_jsx("div", { className: s.root, children: _jsxs("div", { className: s.lotWrapper, children: [isFetching && _jsx(LotCardSkeleton, {}), !isFetching && (_jsx(LotCard, { lot: testLot, handleBtnForm: () => { } })), _jsx("div", { className: s.optionsWrapper, children: _jsxs("label", { className: s.isFetching, children: ["isFetching", _jsx("input", { type: 'checkbox', onClick: () => setIsFetching(!isFetching) })] }) })] }) }));
};
