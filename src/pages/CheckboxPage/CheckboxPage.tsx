			...
			<div className={s.wrapper}>
				<div className={s.lighContainer}>
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setCheckedLightLarge(val)
							console.log('checked light large', val)
						}}
						variant='light'
						size_l>
						light / large / checked
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedLightLarge(val)
							console.log('unchecked light large', val)
						}}
						variant='light'
						size_l>
						light / large / unchecked
					</CheckBox>
					<CheckBox
						isChecked={checkedLightMedium}
						emitIsChecked={(val: boolean) => {
							setCheckedLightMedium(val)
							console.log('checked light medium', val)
						}}
						variant='light'
						size_m>
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedLightMedium(val)
							console.log('unchecked light medium', val)
						}}
						variant='light'
						size_m>
						light / medium / unchecked
					</CheckBox>
					<CheckBox
						isChecked={checkedLightSmall}
						emitIsChecked={(val: boolean) => {
							setCheckedLightSmall(val)
							console.log('checked light small', val)
						}}
						variant='light'
						size_s>
						light / small / checked
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedLightSmall(val)
							console.log('unchecked light small', val)
						}}
						variant='light'
						size_s>
						light / small / unchecked
					</CheckBox>

					<CheckBox
						isChecked={uncheckedLightMediumError}
						emitIsChecked={(val: boolean) => {
							setUncheckedLightMediumError(val)
							console.log('unchecked light medium', val)
						}}
						variant='light'
						error
						size_m>
						light / medium / unchecked / error
					</CheckBox>
					<CheckBox
						isChecked={checkedLightMediumError}
						emitIsChecked={(val: boolean) => {
							setCheckedLightMediumError(val)
							console.log('unchecked light medium', val)
						}}
						variant='light'
						error
				...
				<div className={s.darkContainer}>
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setCheckedDarkLarge(val)
							console.log('checked dark large', val)
						}}
						variant='dark'
						size_l>
						dark / large / checked
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedDarkLarge(val)
							console.log('unchecked dark large', val)
						}}
						variant='dark'
						size_l>
						dark / large / unchecked
					</CheckBox>
					<CheckBox
						isChecked={checkedDarkMedium}
						emitIsChecked={(val: boolean) => {
							setCheckedDarkMedium(val)
							console.log('checked dark medium', val)
						}}
						variant='dark'
						size_m>
						dark / medium / checked
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedDarkMedium(val)
							console.log('unchecked dark medium', val)
						}}
						variant='dark'
						size_m>
						dark / medium / unchecked
					</CheckBox>
					<CheckBox
						isChecked={checkedDarkSmall}
						emitIsChecked={(val: boolean) => {
							setCheckedDarkSmall(val)
							console.log('checked dark small', val)
						}}
						variant='dark'
						size_s>
						dark / small / checked
					...
					<CheckBox
						...
						emitIsChecked={(val: boolean) => {
							setUncheckedDarkSmall(val)
							console.log('unchecked dark small', val)
						}}
						variant='dark'
						size_s>
						dark / small / unchecked
					</CheckBox>

					<CheckBox
						isChecked={uncheckedDarkMediumError}
						emitIsChecked={(val: boolean) => {
							setUncheckedDarkMediumError(val)
							console.log('unchecked dark medium', val)
						}}
						variant='dark'
						size_m
						error>
						dark / medium / unchecked / error
					</CheckBox>

					<CheckBox
						isChecked={checkedDarkMediumError}
						emitIsChecked={(val: boolean) => {
							setCheckedDarkMediumError(val)
							console.log('unchecked dark medium', val)
						}}
						variant='dark'
						size_m
						error>
						dark / medium / checked / error
					</CheckBox>
				</div>
			</div>
		</div>
