            ...
            <div
                ...
                <div
                    ...
                    dangerouslySetInnerHTML={{
                        __html: subTitle ?? `Оставьте номер телефона для получения консультации`,
                    }}
                />
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Flex className={s.inputWrapper}>
                        ...
                        <CheckBox
                            ...
                            {...register('personalCheckBox', {required: true})}
                            //можно указывать либо text либо children
                        >
                            <div>Я принимаю условия <a className={s.linkPolicy} href={'/documents/docs'}>Политики обработки и защиты персональных данных</a>, даю согласия на
